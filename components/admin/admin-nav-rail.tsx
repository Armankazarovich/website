...
const SUBTITLE_BY_HREF: Record<string, string> = {
  ...
  "/admin/suppliers": "Продавцы и предложения",
  ...
  "/admin/site": "Настройки витрины",
  "/admin/site/constructor": "Редактор витрины",
  "/admin/site/benchmarks": "Служебные проекты",
  "/admin/site/releases": "Служебные релизы",
