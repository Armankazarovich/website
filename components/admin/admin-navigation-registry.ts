...
export const allNavItems: NavItem[] = [
  ...
  { href: "/admin/director", label: "Роли и доступы", icon: BriefcaseBusiness, roles: ALL_STAFF, group: "settings", section: "director", description: "продавцы, партнеры, менеджеры и права", moduleId: "business.director-cabinet", searchPriority: 5 },
  ...
  { href: "/admin/aray/orders", label: "Запуск сайта", icon: ArayIcon, roles: [SA, "ADMIN", "MANAGER"], group: "arayCms", section: "launch", description: "служебный запуск проектов, не основной путь ПилоРус", moduleId: "core.aray-voice", searchPriority: 2, surfaces: ["searchPanel", "aray", "direct"] },
  { href: "/admin/aray/briefs", label: "Бриф и материалы", icon: ArayIcon, roles: [SA, "ADMIN", "MANAGER"], group: "arayCms", section: "launch", description: "служебные материалы запуска проектов", moduleId: "core.aray-voice", searchPriority: 3, surfaces: ["searchPanel", "aray", "direct"] },
  { href: "/admin/aray/builder", label: "Сборка сайта", icon: ArayIcon, roles: [SA, "ADMIN", "MANAGER"], group: "arayCms", section: "launch", description: "служебный конструктор для будущих копий", moduleId: "constructor.store-builder", searchPriority: 4, surfaces: ["searchPanel", "aray", "direct"] },
  ...
  { href: "/admin/suppliers", label: "Продавцы / Поставщики", icon: Handshake, roles: [SA, "ADMIN", "MANAGER", "WAREHOUSE", "SELLER"], group: "products", section: "suppliers", description: "витрины продавцов, прайсы, предложения и модерация" },
  ...
  { href: "/admin/site/constructor", label: "Редактор витрины", icon: Globe, roles: [SA, "ADMIN"], group: "settings", section: "site", description: "править текущий сайт ПилоРус", moduleId: "constructor.store-builder" },
  { href: "/admin/site/benchmarks", label: "Сайты и проекты", icon: Stamp, roles: [SA, "ADMIN", "MANAGER"], group: "arayCms", section: "sites", description: "служебные проекты ARAY CMS, домены и запуск", moduleId: "constructor.store-builder", surfaces: ["searchPanel", "aray", "direct"] },
  { href: "/admin/site/releases", label: "Ядро и релизы", icon: Network, roles: [SA, "ADMIN", "MANAGER"], group: "arayCms", section: "sites", description: "служебные версии ARAY, отдельные серверы и запуск сайтов", moduleId: "constructor.store-builder", surfaces: ["searchPanel", "aray", "direct"] },
