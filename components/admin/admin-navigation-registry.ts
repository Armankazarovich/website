...
export const allNavItems: NavItem[] = [
  ...
  { href: "/admin/director", label: "Роли и доступы", icon: BriefcaseBusiness, roles: ALL_STAFF, group: "settings", section: "director", description: "команда, менеджеры и права", moduleId: "business.director-cabinet", searchPriority: 5 },
  ...
  { href: "/admin/suppliers", label: "Поставщики", icon: Package, roles: [SA, "ADMIN"], group: "products", section: "suppliers", description: "служебный запас для будущих поставщиков", surfaces: ["direct"] },
  ...
  { href: "/admin/site/constructor", label: "Служебный конструктор", icon: Globe, roles: [SA, "ADMIN"], group: "settings", section: "site", description: "служебный запас для будущих копий сайтов", moduleId: "constructor.store-builder", surfaces: ["direct"] },
