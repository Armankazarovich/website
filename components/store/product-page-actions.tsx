...
export function ProductSmartSummary({ sku, category, tags }: ProductSmartSummaryProps) {
  return (
    <div data-product-smart-summary className="store-product-smart-summary mt-4 rounded-2xl border p-3">
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
        <div className="flex min-w-0 items-center gap-2">
          <span className="store-icon-tile h-9 w-9 rounded-xl">
            <Tag className="h-4 w-4" />
          </span>
          <div className="min-w-0">
            <p className="text-[11px] font-semibold uppercase tracking-[0.08em] text-muted-foreground">Артикул</p>
            <p data-product-sku className="truncate text-sm font-bold text-foreground">{sku}</p>
          </div>
        </div>
        <div className="inline-flex max-w-full items-center gap-1 rounded-full border border-border/70 bg-background/70 px-2.5 py-1 text-xs font-semibold text-muted-foreground">
    ...
    <section data-product-seller-panel className="store-product-seller-panel rounded-2xl border p-3 sm:p-4">
      <div className="flex items-start justify-between gap-3">
        <div className="flex min-w-0 items-start gap-3">
          ...
          <div className="min-w-0">
            <h2 className="text-base font-bold leading-tight">Онлайн-продавец</h2>
            <p className="mt-1 text-xs leading-5 text-muted-foreground">
              Вопрос, заявка, отзыв или предложение сразу привязаны к товару.
            </p>
          </div>
        </div>
        <button
