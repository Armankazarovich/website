        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
          ...
          <div>
            <Link href="/" className="flex items-center gap-3 mb-4">
              ...
              <div>
                <p className="font-display font-bold text-2xl text-zinc-900 dark:text-white">ПилоРус</p>
                <p className="text-xs text-zinc-500 dark:text-zinc-500">Пиломатериалы от производителя</p>
              </div>
            </Link>
            ...
            <div className="mb-4">
              <p className="text-xs text-zinc-500 dark:text-zinc-500 mb-2 uppercase tracking-widest font-medium">Поделиться</p>
              <div className="flex items-center gap-2">
                <a
                  ...
                  className="w-9 h-9 rounded-xl backdrop-blur-sm bg-zinc-900/5 border border-zinc-900/10 dark:bg-white/5 dark:border-white/10 hover:bg-[#0077FF]/80 hover:border-[#0077FF]/50 transition-all duration-200 flex items-center justify-center group"
                >
                  <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor" className="text-zinc-500 dark:text-zinc-400 group-hover:text-white transition-colors">
                ...
                <a
                  ...
                  className="w-9 h-9 rounded-xl backdrop-blur-sm bg-zinc-900/5 border border-zinc-900/10 dark:bg-white/5 dark:border-white/10 hover:bg-[#25D366]/80 hover:border-[#25D366]/50 transition-all duration-200 flex items-center justify-center group"
                >
                  <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor" className="text-zinc-500 dark:text-zinc-400 group-hover:text-white transition-colors">
                ...
                <a
                  ...
                  className="w-9 h-9 rounded-xl backdrop-blur-sm bg-zinc-900/5 border border-zinc-900/10 dark:bg-white/5 dark:border-white/10 hover:bg-[#2AABEE]/80 hover:border-[#2AABEE]/50 transition-all duration-200 flex items-center justify-center group"
                >
                  <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor" className="text-zinc-500 dark:text-zinc-400 group-hover:text-white transition-colors">
            ...
            <div className="mb-5">
              <p className="text-xs text-zinc-500 dark:text-zinc-500 mb-2 uppercase tracking-widest font-medium">Установить приложение</p>
              <PwaFooterBadges />
            </div>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-sm text-zinc-600 dark:text-zinc-400">
              ...
              <li className="pt-1">
                <Link href="/catalog" className="text-zinc-800 dark:text-zinc-300 hover:text-brand-orange transition-colors font-medium">
                  Весь каталог →
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-sm text-zinc-600 dark:text-zinc-400">
              ...
              <li>
                <Link href="/news" className="hover:text-brand-orange transition-colors flex items-center gap-2 group">
                  <span className="w-1 h-1 rounded-full bg-zinc-400 dark:bg-zinc-600 group-hover:bg-brand-orange transition-colors" />
                  Новости и статьи
                </Link>
              </li>
      ...
      <div className="border-t border-zinc-200 dark:border-zinc-800 mt-4">
        <div className="container py-4 flex flex-col sm:flex-row justify-between items-center gap-2 text-sm text-zinc-500 dark:text-zinc-600">
          ...
          <div className="flex items-center gap-3 flex-wrap justify-center sm:justify-end">
            ...
            <Link href="/terms" className="hover:text-zinc-800 dark:hover:text-zinc-400 transition-colors underline underline-offset-2">
