    ...
    <section className="space-y-3">
      <div className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
        <AdminSectionTitle
          ...
          subtitle="Direct, Метрика, UTM и заказы за 30 дней"
        />
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        <StatCard
          ...
          sub={
            directReady
              ? `${direct.clicks} кликов · CTR ${formatPercent(direct.ctr)}`
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="aray-stat-card space-y-3">
          <AdminSectionTitle
            ...
            subtitle={metrikaReady ? `${metrika.users} пользователей` : "ждет подключения"}
          />
          {metrikaReady && metrika.sources.length ? (
            ...
            <p className="text-sm text-muted-foreground">
              После подключения Метрики ARAY покажет спрос, источники и качество трафика без внешних таблиц.
            </p>
          )}
        </div>
        ...
        <div className="aray-stat-card space-y-3">
          <AdminSectionTitle
            ...
            subtitle={metrikaReady ? "по визитам и целям" : "нужна Метрика"}
          />
          {metrikaReady && metrika.regions.length ? (
            ...
            <p className="text-sm text-muted-foreground">
              Регионы появятся из Метрики. Если данных нет, ARAY честно оставит блок пустым.
            </p>
          )}
        </div>
      </div>
        ...
        return (
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="aray-stat-card space-y-3">
              ...
              {totalSourceOrders === 0 ? (
                <p className="text-sm text-muted-foreground text-center py-6">
                  Нет заказов с UTM-атрибуцией за 30 дней.
                  <br />
