...
- [ ] ARAY: поиск и ARAY должны говорить одним языком быстрых действий: если можно открыть раздел сразу - открыть и сказать коротко, что сделано; если нужно действие с риском - через подтверждение.
