...
export default async function ServicesPage() {
  ...
  const whatsappMessage = getSetting(siteSettings, "whatsapp_message") || "Здравствуйте! Меня интересуют ваши услуги.";
  ...
  const telegramMessage = getSetting(siteSettings, "telegram_message") || "Здравствуйте! Меня интересуют ваши услуги.";
                ...
                <div className="flex gap-2 flex-wrap">
                  ...
                  {telegramEnabled && telegramLink && (
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-[#2AABEE] text-white text-sm font-semibold hover:bg-[#2AABEE]/90 transition-colors"
                    >
                      <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
