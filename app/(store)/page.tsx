...
const faqSchema = {
  ...
  "mainEntity": [
    ...
    },
    {
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Да, ООО ДЕРЕВОЛИДЕР (ПилоРус) работает с юридическими лицами и ИП. Выставляем счета, заключаем договора, предоставляем полный пакет документов. Оплата по безналичному расчёту."
      }
    },
    {
      "@type": "Question",
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="space-y-4 text-white/80 leading-relaxed">
                <p>
                  ООО «ДЕРЕВОЛИДЕР» — производитель пиломатериалов, расположенный в Химках
