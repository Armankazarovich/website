...
const advantages = [
  ...
  },
  {
    ...
    description: "Режим работы 09:00–18:00, 7 дней в неделю. Всегда готовы помочь с выбором.",
    color: "text-brand-orange",
    bg: "bg-brand-orange/10 dark:bg-brand-orange/15",
  },
  {
              ...
              {[
                {
                  ...
                  items: ["Москва и МО — 1-3 рабочих дня", "Собственный транспорт, погрузка включена", "Работаем ежедневно 09:00–18:00"],
                },
                {
                  svg: <IconWarehouse className="w-6 h-6 text-brand-green" />,
                  bg: "bg-brand-green/10 dark:bg-brand-green/15",
                  title: "Самовывоз со склада",
                  items: ["Химки, Заводская 2А, стр.28", "Режим: ежедневно 09:00–18:00", "Помощь погрузчика, предзаказ по телефону"],
                },
                {
                  svg: (
