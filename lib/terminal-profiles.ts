...
export const TERMINAL_PROFILES: Record<TerminalProfileKey, TerminalProfile> = {
  ...
  construction: {
    key: "construction",
    label: "Стройка / объект",
    shortLabel: "Объект",
    positionWord: "позиция",
    searchPlaceholder: "Поиск материала, работы, техники или услуги...",
    sourceLabel: "Проект",
    sourcePlaceholder: "объект, смета, бригада, прораб",
    customerNameLabel: "Заказчик",
    customerNamePlaceholder: "Заказчик или объект",
    customerPhoneLabel: "Телефон",
    fulfillmentTitle: "Исполнение",
    defaultFulfillment: "OBJECT",
    costLabel: "Логистика",
    costPlaceholder: "0 = без логистики",
    calculatorLabel: "Логистика",
    productionTarget: "объект / бригада / склад",
    pipeline: {
      orderStatuses: ["Заявка", "Смета", "Согласование", "В работе", "Готово", "Закрыто", "Отмена"],
      paymentStatuses: ["Ожидает оплату", "Счёт отправлен", "Аванс", "Оплачено", "Акт/закрытие", "Ошибка"],
      workStatuses: ["Проект", "Материалы", "Бригада", "На объекте", "Приёмка"],
      crmStageMap: DEFAULT_CRM_STAGE_MAP,
    },
    fulfillment: [
      {
        value: "OBJECT",
        label: "На объект",
        detailLabel: "Адрес объекта",
        detailPlaceholder: "адрес, объект, этап работ",
        requiresDetail: true,
        hasDeliveryCost: true,
      },
      {
      ...
      },
      {
        value: "TEAM",
        label: "Бригада",
        detailLabel: "Бригада / зона",
        detailPlaceholder: "бригада, участок, задача",
        requiresDetail: true,
        hasDeliveryCost: false,
      },
    ],
