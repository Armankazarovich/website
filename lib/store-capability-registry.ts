...
export const STORE_CAPABILITY_REGISTRY: StoreCapability[] = [
  ...
  },
  {
    ...
    title: "One-click store constructor",
    status: "foundation",
    publicValue: "Owner can prepare a new store from a checked business blueprint without breaking the PiloRus baseline.",
    adminRoutes: ["/admin/site/constructor", "/admin/business/settings", "/admin/site", "/admin/products"],
    dependencies: [
      "tenant",
      "site-settings",
      "terminal-profiles",
    ...
    dataObjects: ["Tenant", "SiteSettings", "Category", "Product", "ProductVariant", "ArayModuleState"],
    arayRole: "Build the launch checklist, warn about missing owner inputs and run preflight before any deploy.",
    risk: "high",
  },
  {
