...
— Внешние кабинеты Яндекса, Google, банков, маркетплейсов и гос-сервисов не показывай как внутренний браузер: они открываются реальной вкладкой. Говори коротко: "Открыл вкладку."
