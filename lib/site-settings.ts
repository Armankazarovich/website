...
export const DEFAULT_SETTINGS: Record<string, string> = {
  ...
  catalog_description: "Каталог ПилоРус: доска, брус, вагонка, блок-хаус, фанера и листовые материалы с актуальными ценами, размерами и доставкой по Москве и Московской области.",
